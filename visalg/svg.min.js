...
;var SVG = function() {
    ...
    }, y = o("object" == typeof globalThis && globalThis) || o("object" == typeof window && window) || o("object" == typeof self && self) || o("object" == typeof t && t) || Function("return this")(), m = function(t) {
        try {
            return !!t()
        } catch (t) {
            return !0
    ...
    }), F = L("native-function-to-string", Function.toString), z = y.WeakMap, q = "function" == typeof z && /native code/.test(F.call(z)), Y = 0, X = Math.random(), V = function(t) {
    ...
    var tt = {
      ...
      , et = e(function(t) {
        ...
        (t.exports = function(t, e, n, r) {
            var i = !!r && !!r.unsafe
              , o = !!r && !!r.enumerable
              , s = !!r && !!r.noTargetGet;
            "function" == typeof n && ("string" != typeof e || x(n, "name") || I(n, "name", e),
            u(n).source = a.join("string" == typeof e ? e : "")),
            t !== y ? (i ? !s && t[e] && (o = !0) : delete t[e],
            o ? t[e] = n : I(t, e, n)) : o ? t[e] = n : N(e, n)
        }
      ...
      , yt = function(t, e) {
        var n, r = d(t), i = 0, o = [];
        for (n in r)
            !x(U, n) && x(r, n) && o.push(n);
        for (; e.length > i; )
            x(r, n = e[i++]) && (~pt(o, n) || o.push(n));
        return o
    }
      ...
      , _t = it("Reflect", "ownKeys") || function(t) {
        var e = wt.f(T(t))
          , n = bt.f;
      ...
      , Dt = !Nt || m(function() {
        ...
        for (var n = It(t), r = arguments.length, i = 1, o = bt.f, s = v.f; i < r; )
            for (var u, a = _(arguments[i++]), h = o ? Pt(a).concat(o(a)) : Pt(a), l = h.length, c = 0; c < l; )
                u = h[c++],
                f && !s.call(a, u) || (n[u] = a[u]);
        return n
    }
    : Nt;
    Ct({
    ...
    Ct({
        ...
        slice: function(t, e) {
            ...
            if (Ft(o) && ("function" != typeof (n = o.constructor) || n !== Array && !Ft(n.prototype) ? g(n) && null === (n = n[Jt]) && (n = void 0) : n = void 0,
            n === Array || void 0 === n))
                return Zt.call(o, u, a);
            for (r = new (void 0 === n ? Array : n)(Kt(a - u, 0)),
            i = 0; u < a; u++,
            i++)
                u in o && zt(r, i, o[u]);
            return r.length = i,
    ...
    var we = {
      ...
      , ke = Gt("toStringTag")
      , Oe = function(t, e, n) {
        t && !x(t = n ? t : t.prototype, ke) && xe(t, ke, {
            configurable: !0,
            value: e
        })
    }
      ...
      , Me = function(t, e) {
        var n;
        return Ft(t) && ("function" != typeof (n = t.constructor) || n !== Array && !Ft(n.prototype) ? g(n) && null === (n = n[je]) && (n = void 0) : n = void 0),
      ...
      , Te = function(v) {
        ...
        return function(t, e, n, r) {
            for (var i, o, s = It(t), u = _(s), a = Ae(e, n, 3), h = ht(u.length), l = 0, c = r || Me, f = d ? c(t, h) : p ? c(t, 0) : void 0; l < h; l++)
                if ((w || l in u) && (o = a(i = u[l], l, s),
                v))
                    if (d)
                        f[l] = o;
                    else if (o)
    ...
    : function(t) {
      ...
      , rn = function(t, e, n) {
        ...
        var r = p(e, !0);
        return T(n),
        x(Ue, r) ? (n.enumerable ? (x(t, Ie) && t[Ie][r] && (t[Ie][r] = !1),
        n = ge(n, {
            enumerable: b(0, !1)
        })) : (x(t, Ie) || Ve(t, Ie, b(1, {})),
        t[Ie][r] = !0),
      ...
      , un = function(t, e) {
        ...
        if (n !== ze || !x(Ue, r) || x($e, r)) {
            var i = Ge(n, r);
            return !i || !x(Ue, r) || x(n, Ie) && n[Ie][r] || (i.enumerable = !0),
            i
        }
    }
      , an = function(t) {
    ...
    wt.f = ue.f = an,
    bt.f = hn,
    f && (Ve(qe[De], "description", {
        configurable: !0,
        get: function() {
            return Fe(this).description
        }
    }),
    et(ze, "propertyIsEnumerable", sn, {
        unsafe: !0
    })),
    we.f = function(t) {
        return en(Gt(t), t)
    ...
    var bn, _n, xn, kn = function(t) {
        ...
        return t = It(t),
        x(t, An) ? t[An] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? jn : null
    }
    , En = Gt("iterator"), Tn = !1;
    [].keys && ("next"in (xn = [].keys()) ? (_n = Mn(Mn(xn))) !== Object.prototype && (bn = _n) : Tn = !0),
    null == bn && (bn = {}),
    x(bn, En) || I(bn, En, function() {
        return this
    });
    var Cn = {
      ...
      , Yn = function(t, e, n, r, i, o, s) {
        ...
        }, d = e + " Iterator", p = !1, y = t.prototype, m = y[Ln] || y["@@iterator"] || i && y[i], g = !Rn && m || v(i), w = "Array" == e && y.entries || m;
        if (w && (l = Mn(w.call(new t)),
        Dn !== Object.prototype && l.next && (Mn(l) !== Dn && (Nn ? Nn(l, Dn) : "function" != typeof l[Ln] && I(l, Ln, qn)),
        Oe(l, d, !0))),
        i == Fn && m && m.name !== Fn && (p = !0,
        g = function() {
            return m.call(this)
        }
        ),
      ...
      , Gn = tt.set
      , Vn = tt.getterFor(Xn)
      , Hn = Yn(Array, "Array", function(t, e) {
        Gn(this, {
            type: Xn,
            target: d(t),
            index: 0,
    ...
    On.Arguments = On.Array,
    kn("keys"),
    kn("values"),
    kn("entries");
    var Bn = Gt("toStringTag")
      , Un = "Arguments" == h(function() {
        return arguments
    }())
      , $n = function(t) {
        var e, n, r;
    ...
    : Qn.toString
      , Jn = Object.prototype;
    Wn !== Jn.toString && et(Jn, "toString", Wn, {
        unsafe: !0
    });
    var Zn = !m(function() {
      ...
      , Kn = e(function(t) {
        var e = P.f
          ...
          , s = t.exports = {
            ...
            onFreeze: function(t) {
                return Zn && s.REQUIRED && i(t) && !x(t, n) && o(t),
                t
            }
        };
        U[n] = !0
        ...
        (t.exports = function(t, e, n, r, i) {
            ...
            if (i)
                ...
                if ("function" != typeof (s = function(t) {
                    if (null != t)
                        return t[nr] || t["@@iterator"] || On[$n(t)]
                }(t)))
                    throw TypeError("Target is not iterable");
                if (void 0 !== (f = s) && (On.Array === f || er[tr] === f)) {
                    for (u = 0,
                    a = ht(t.length); u < a; u++)
                        if ((h = r ? v(T(c = t[u])[0], c[1]) : v(t[u])) && h instanceof d)
                            return h;
                    return new d(!1)
                }
                o = s.call(t)
            ...
            for (l = o.next; !(c = l.call(o)).done; )
                if ("object" == typeof (h = rr(o, v, c.value, r)) && h && h instanceof d)
                    return h;
            return new d(!1)
        }
        ).stop = function(t) {
    ...
    var lr = function(t, e, n) {
        var r, i;
        return Nn && "function" == typeof (r = e.constructor) && r !== n && g(i = r.prototype) && i !== n.prototype && Nn(t, i),
        t
    }
      , cr = function(t, e, n) {
        for (var r in e)
      ...
      , mr = (function(r, t, e, i, o) {
        ...
        getConstructor: function(t, n, r, i) {
            ...
            return cr(o.prototype, {
                ...
                forEach: function(t) {
                    for (var e, n = u(this), r = Ae(t, 1 < arguments.length ? arguments[1] : void 0, 3); e = e ? e.next : n.first; )
    ...
    var Fr, zr, qr = function() {
        ...
        t.sticky && (e += "y"),
        e
    }, Yr = RegExp.prototype.exec, Xr = String.prototype.replace, Gr = Yr, Vr = (Fr = /a/,
    zr = /b*/g,
    Yr.call(Fr, "a"),
    Yr.call(zr, "a"),
    0 !== Fr.lastIndex || 0 !== zr.lastIndex), Hr = void 0 !== /()??/.exec("")[1];
    (Vr || Hr) && (Gr = function(t) {
        var e, n, r, i, o = this;
        return Hr && (n = new RegExp("^" + o.source + "$(?!\\s)",qr.call(o))),
        Vr && (e = o.lastIndex),
        r = Yr.call(o, t),
        Vr && r && (o.lastIndex = o.global ? r.index + r[0].length : e),
        Hr && r && 1 < r.length && Xr.call(r[0], n, function() {
    ...
    var Wr = Gt("species")
      ...
      , Kr = function(n, t, e, r) {
        ...
        if (!o || !s || "replace" === n && !Jr || "split" === n && !Zr) {
            ...
            et(RegExp.prototype, i, 2 == t ? function(t, e) {
    ...
    Kr("replace", 2, function(i, _, x) {
        ...
        , function(t, e) {
            ...
            for (var l, c = "", f = 0, v = 0; v < a.length; v++) {
                h = a[v];
                for (var d = String(h[0]), p = ri(ii(ut(h.index), i.length), 0), y = [], m = 1; m < h.length; m++)
    ...
    var ai, hi = "\t\n\v\f\r                　\u2028\u2029\ufeff", li = "[" + hi + "]", ci = RegExp("^" + li + li + "*"), fi = RegExp(li + li + "*$"), vi = function(n) {
        return function(t) {
            var e = String(c(t));
            return 1 & n && (e = e.replace(ci, "")),
            2 & n && (e = e.replace(fi, "")),
            e
        }
    }, di = {
    ...
    function _i(t, e, n, r) {
        return null != e && null != n || (r = r || t.bbox(),
    ...
    function Li(t) {
        if (!t)
            return null;
        if (t.instance instanceof Ci)
            return t.instance;
        var e = bi(t.nodeName || "Dom");
        return "LinearGradient" === e || "RadialGradient" === e ? e = "Gradient" : Pi[e] || (e = "Dom"),
        new Pi[e](t)
    }
    var Fi = Li;
    function zi(t) {
    ...
    Nr("Dom", {
        ...
        backward: function() {
            var t = this.position();
            return 0 < t && this.parent().removeElement(this).add(this, t - 1),
            this
        },
        front: function() {
            var t = this.parent();
        ...
        back: function() {
            return 0 < this.position() && this.parent().removeElement(this).add(this, 0),
            this
        },
        before: function(t) {
            (t = Di(t)).remove();
        ...
        insertBefore: function(t) {
            return (t = Di(t)).before(this),
            this
        },
        insertAfter: function(t) {
            return (t = Di(t)).after(this),
            this
        }
    });
    var Bi = Ce.filter;
    ...
    Kr("split", 2, function(i, g, w) {
        ...
        return b = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || 1 < ".".split(/()()/).length || "".split(/.?/).length ? function(t, e) {
            ...
            if (!$r(t))
                return g.call(n, t, r);
            for (var i, o, s, u = [], a = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), h = 0, l = new RegExp(t.source,a + "g"); (i = Br.call(l, n)) && !(h < (o = l.lastIndex) && (u.push(n.slice(h, i.index)),
            1 < i.length && i.index < n.length && no.apply(u, i.slice(1)),
            s = i[0].length,
            h = o,
            u.length >= r)); )
                l.lastIndex === i.index && l.lastIndex++;
            return h === n.length ? !s && l.test("") || u.push("") : u.push(n.slice(h)),
        ...
        , function(t, e) {
            ...
            if (n.done)
                return n.value;
            var r, i, o, s = T(t), u = String(this), a = (r = RegExp,
            void 0 === (o = T(s).constructor) || null == (i = T(o)[eo]) ? r : Se(i)), h = s.unicode, l = (s.ignoreCase ? "i" : "") + (s.multiline ? "m" : "") + (s.unicode ? "u" : "") + (oo ? "y" : "g"), c = new a(oo ? s : "^(?:" + s.source + ")",l), f = void 0 === e ? io : e >>> 0;
            if (0 === f)
                return [];
            if (0 === u.length)
                return null === ni(c, u) ? [u] : [];
            for (var v = 0, d = 0, A = []; d < u.length; ) {
                c.lastIndex = oo ? d : 0;
                var p, y = ni(c, oo ? u : u.slice(d));
                if (null === y || (p = ro(ht(c.lastIndex + (oo ? 0 : d)), u.length)) === v)
                    d = ei(u, d, h);
                else {
                    if (A.push(u.slice(v, d)),
                    A.length === f)
                        return A;
    ...
    Nr("Dom", {
        css: function(t, e) {
            ...
            if (0 === arguments.length)
                return this.node.style.cssText.split(/\s*;\s*/).filter(function(t) {
                    return !!t.length
                }).forEach(function(t) {
                    var e = t.split(/\s*:\s*/);
                    n[e[0]] = e[1]
            ...
            if (arguments.length < 2) {
                ...
                if ("string" == typeof t)
                    return this.node.style[gi(t)];
                if ("object" === ce(t))
                    for (var h in t)
                        this.node.style[gi(h)] = null == t[h] || po.test(t[h]) ? "" : t[h]
            }
            return 2 === arguments.length && (this.node.style[gi(t)] = null == e || po.test(e) ? "" : e),
            this
        },
        show: function() {
    ...
    function Lo(t, e, s, u) {
        ...
        ("function" != typeof s || (s = s._svgjsListenerId)) && (e = Array.isArray(e) ? e : (e || "").split(go)).forEach(function(t) {
            ...
            if (s)
                h[i] && h[i][o || "*"] && (l.removeEventListener(i, h[i][o || "*"][s], u || !1),
                delete h[i][o || "*"][s]);
            else if (i && o) {
                if (h[i] && h[i][o]) {
                    for (n in h[i][o])
    ...
    var fs = function() {
        ...
        return as(T, [{
            key: "init",
            value: function() {
                var t, e, n, r, i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0, o = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0, s = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0, u = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : 0, a = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : "rgb";
                if (i = i || 0,
                this.space)
                    for (var h in this.space)
                        delete this[this.space[h]];
                if ("number" == typeof i)
                    ...
                    this.space = o || ("string" == typeof i[3] ? i[3] : i[4]) || "rgb",
                    Object.assign(this, {
                        _a: i[0],
                        _b: i[1],
                        _c: i[2],
                    ...
                    if (vo.test(i)) {
                        var c = i.replace(co, "")
                          , f = ss(ao.exec(c).slice(1, 4).map(function(t) {
                            return parseInt(t)
                        }), 3)
                          , v = f[0]
                          , d = f[1]
                        ...
                        var y = ss(uo.exec((t = i,
                        4 === t.length ? ["#", t.substring(1, 2), t.substring(1, 2), t.substring(2, 3), t.substring(2, 3), t.substring(3, 4), t.substring(3, 4)].join("") : t)).map(function(t) {
                ...
                if ("lab" === (O = this.space) || "xyz" === O || "lch" === O) {
                    ...
                    if ("lab" === this.space || "lch" === this.space) {
                        ...
                        var h = (r + 16) / 116
                          ...
                          , f = 16 / 116
                          , v = .008856;
                        t = .95047 * (Math.pow(l, 3) > v ? Math.pow(l, 3) : (l - f) / 7.787),
                        e = 1 * (Math.pow(h, 3) > v ? Math.pow(h, 3) : (h - f) / 7.787),
                        n = 1.08883 * (Math.pow(c, 3) > v ? Math.pow(c, 3) : (c - f) / 7.787)
                    }
                    var d = 3.2406 * t + -1.5372 * e + -.4986 * n
                      , p = -.9689 * t + 1.8758 * e + .0415 * n
                      , y = .0557 * t + -.204 * e + 1.057 * n
                      , m = Math.pow
                      , g = .0031308;
            ...
            value: function() {
                var t = this.rgb()
                  , e = ss([t._a, t._b, t._c].map(function(t) {
                    return t / 255
                }), 3)
                  , n = e[0]
                  , r = e[1]
                  , i = e[2]
                  , o = .04045 < n ? Math.pow((n + .055) / 1.055, 2.4) : n / 12.92
                  , s = .04045 < r ? Math.pow((r + .055) / 1.055, 2.4) : r / 12.92
                  , u = .04045 < i ? Math.pow((i + .055) / 1.055, 2.4) : i / 12.92
                  , a = (.4124 * o + .3576 * s + .1805 * u) / .95047
                  , h = (.2126 * o + .7152 * s + .0722 * u) / 1
            ...
            value: function() {
                ...
                if ("sine" === t)
                    return new T(r(80 * i(2 * o * (e = null == e ? n() : e) / .5 + .01) + 150),r(50 * i(2 * o * e / .5 + 4.6) + 200),r(100 * i(2 * o * e / .5 + 2.3) + 150));
                if ("pastel" === t)
                    return new T(8 * n() + 86,17 * n() + 9,360 * n(),"lch");
                if ("dark" === t)
                    return new T(10 + 10 * n(),50 * n() + 86,360 * n(),"lch");
                if ("rgb" === t)
                    return new T(255 * n(),255 * n(),255 * n());
                if ("lab" === t)
                    return new T(100 * n(),256 * n() - 128,256 * n() - 128,"lab");
                if ("grey" === t) {
                    var s = 255 * n();
                    return new T(s,s,s)
                }
    ...
    Kr("match", 1, function(r, a, h) {
        ...
        , function(t) {
            ...
            for (var i, o = n.unicode, A = [], s = n.lastIndex = 0; null !== (i = ni(n, r)); ) {
                var u = String(i[0]);
                "" === (A[s] = u) && (n.lastIndex = ei(r, ht(n.lastIndex), o)),
                s++
            }
            return 0 === s ? null : A
        }
      ...
      , Ms = function(t) {
        ...
        if ("string" == typeof h && 2 < h.length)
            if (43 === (e = (h = ks(h)).charCodeAt(0)) || 45 === e) {
                ...
                for (s = (o = h.slice(2)).length,
                u = 0; u < s; u++)
                    if ((a = o.charCodeAt(u)) < 48 || i < a)
                        return NaN;
                return parseInt(o, r)
            }
        return +h
    ...
    if (Et(Os, !Ss(" 0o1") || !Ss("0b1") || Ss("+0x1"))) {
        ...
        }, Cs = f ? bs(Ss) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), Ps = 0; Cs.length > Ps; Ps++)
            x(Ss, Es = Cs[Ps]) && !x(Ts, Es) && xs(Ts, Es, _s(Ss, Es));
        (Ts.prototype = As).constructor = Ts,
        et(y, Os, Ts)
    }
    var Is = di.trim
      , Ns = y.parseFloat
      , Ds = 1 / Ns(hi + "-0") != -1 / 0 ? function(t) {
        var e = Is(String(t))
          , n = Ns(e);
    ...
    var Fs = function() {
        ...
        return as(h, [{
            ...
            value: function(t) {
                ...
                return t = t instanceof Element ? t.matrixify() : "string" == typeof t ? h.fromArray(t.split(go).map(parseFloat)) : Array.isArray(t) ? h.fromArray(t) : "object" === ce(t) && h.isMatrixLike(t) ? t : "object" === ce(t) ? (new h).transform(t) : 6 === arguments.length ? h.fromArray([].slice.call(arguments)) : e,
            ...
            value: function(t) {
                ...
                return o.translateO(e.tx, e.ty),
                o
            }
        }, {
            key: "compose",
            value: function(t) {
                t.origin && (t.originX = t.origin[0],
                t.originY = t.origin[1]);
                var e = t.originX || 0
                  , n = t.originY || 0
                  , r = t.scaleX || 1
                  , i = t.scaleY || 1
            ...
            value: function(t) {
                var e = "both" === t.flip || !0 === t.flip
                  ...
                  , l = new Rs(t.origin || t.around || t.ox || t.originX,t.oy || t.originY)
                  , c = l.x
                  , f = l.y
                  , v = new Rs(t.position || t.px || t.positionX,t.py || t.positionY)
                  , d = v.x
                  , p = v.y
                  , y = new Rs(t.translate || t.tx || t.translateX,t.ty || t.translateY)
                  , m = y.x
                  , g = y.y
    ...
    function zs() {
        if (!zs.nodes) {
            var t = Di().size(2, 0);
            t.node.style.cssText = ["opacity: 0", "position: absolute", "left: -100%", "top: -100%", "overflow: hidden"].join(";"),
    ...
    var Ys = function() {
        ...
        return as(s, [{
            key: "init",
            value: function(t) {
                return t = "string" == typeof t ? t.split(go).map(parseFloat) : Array.isArray(t) ? t : "object" === ce(t) ? [null != t.left ? t.left : t.x, null != t.top ? t.top : t.y, t.width, t.height] : 4 === arguments.length ? [].slice.call(arguments) : [0, 0, 0, 0],
                this.x = t[0] || 0,
                this.y = t[1] || 0,
            ...
            key: "addOffset",
            value: function() {
                return this.x += Ei.window.pageXOffset,
    ...
    Nr({
        viewbox: {
            ...
            zoom: function(t, e) {
                ...
                var l = new Ys(i).transform(new Fs({
                    scale: h,
                    origin: e
                }));
        ...
        try {
            ...
            return function(t) {
                ...
                return ((r.prototype = Object.create(e.prototype)).constructor = r).prototype.map = function(t) {
                    var e = new r;
                    return e.push.apply(e, Array.prototype.map.call(this, t)),
                    e
                }
                ,
                r
    ...
    var Us = function(t) {
        function r() {
            var t, e = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).events, n = void 0 === e ? {} : e;
            return Ti(this, r),
            (t = ps(this, ys(r).call(this))).events = n,
            t
        }
        return ws(r, Ci),
        as(r, [{
    ...
    Vi(Zs, {
        init: function(t) {
            return "number" == typeof t || (this.length = 0,
            this.push.apply(this, Cr(this.parse(t)))),
            this
        },
        toArray: function() {
            return Array.prototype.concat.apply([], this)
    ...
    var Ks = function() {
        ...
        return as(n, [{
            key: "init",
            value: function(t, e) {
                return e = Array.isArray(t) ? t[1] : e,
                t = Array.isArray(t) ? t[0] : t,
                this.value = 0,
                this.unit = e || "",
                "number" == typeof t ? this.value = isNaN(t) ? 0 : isFinite(t) ? t : t < 0 ? -34e37 : 34e37 : "string" == typeof t ? (e = t.match(so)) && (this.value = parseFloat(e[1]),
                "%" === e[5] ? this.value /= 100 : "s" === e[5] && (this.value *= 1e3),
                this.unit = e[5]) : t instanceof n && (this.value = t.valueOf(),
                this.unit = t.unit),
                this
            }
        }, {
    ...
    var Dom = function(t) {
        ...
        as(Dom, [{
            ...
            key: "id",
            value: function(t) {
                return void 0 !== t || this.node.id || (this.node.id = Xi(this.type)),
                this.attr("id", t)
            }
        }, {
            key: "index",
            ...
            value: function(t) {
                ...
                if (!e.node.parentNode)
                    return null;
                if (e = Li(e.node.parentNode),
                !t)
                    return e;
                for (; e; ) {
                    if ("string" == typeof t ? e.matches(t) : e instanceof t)
                        return e;
                    if (!e.node.parentNode || "#document" === e.node.parentNode.nodeName || "#document-fragment" === e.node.parentNode.nodeName)
                        return null;
    ...
    Vi(Dom, {
        attr: function(n, t, e) {
            ...
            if ("object" === ce(n) && n.constructor === Object)
                ...
                if (null == t)
                    return null == (t = this.node.getAttribute(n)) ? Ws[n] : yo.test(t) ? parseFloat(t) : t;
                "number" == typeof (t = tu.reduce(function(t, e) {
                    return e(n, t, r)
                }, t)) ? t = new Ks(t) : fs.isColor(t) ? t = new fs(t) : t.constructor === Array && (t = new Zs(t)),
                "leading" === n ? this.leading && this.leading(t) : "string" == typeof e ? this.node.setAttributeNS(e, n, t.toString()) : this.node.setAttribute(n, t.toString()),
    ...
    var Element = function(t) {
        function Element(t, e) {
            var n;
            return Ti(this, Element),
            (n = ps(this, ys(Element).call(this, t, e))).dom = {},
            n.node.instance = ds(n),
            t.hasAttribute("svgjs:data") && n.setData(JSON.parse(t.getAttribute("svgjs:data")) || {}),
            n
        }
        return ws(Element, Dom),
        as(Element, [{
            key: "center",
            value: function(t, e) {
            ...
            value: function() {
                ...
                t = Di(t);
                for (var e = new Vs, n = this; (n = n.parent()) && n.node !== t.node && n.node !== Ei.document; )
                    e.push(n);
                return e
            }
        }, {
    ...
    ["fill", "stroke"].forEach(function(e) {
        ...
        t[e] = function(t) {
            if (void 0 === t)
                return this.attr(e);
            if ("string" == typeof t || t instanceof fs || fs.isRgb(t) || t instanceof Element)
                this.attr(e, t);
            else
    ...
    Nr(["Element", "Runner"], {
        ...
        flip: function(t, e) {
            var n = "string" == typeof t ? t : (isFinite(t),
            "both")
    ...
    Nr("Element", ["click", "dblclick", "mousedown", "mouseup", "mouseover", "mouseout", "mousemove", "mouseenter", "mouseleave", "touchstart", "touchmove", "touchleave", "touchend", "touchcancel"].reduce(function(t, e) {
        return t[e] = function(t) {
            return null === t ? Lo(this, e) : Ro(this, e, t),
            this
        }
        ,
        t
    ...
    Ct({
        target: "Array",
        proto: !0,
        forced: String(ru) === String(ru.reverse())
    }, {
        reverse: function() {
            return Ft(this) && (this.length = this.length),
            nu.call(this)
        }
    }),
    Ct({
    ...
    Ct({
        ...
        getOwnPropertyDescriptors: function(t) {
            for (var e, n, r = d(t), i = E.f, o = _t(r), s = {}, u = 0; o.length > u; )
    ...
    var yu = {
      ...
      , Shape = function(t) {
        function Shape() {
            return Ti(this, Shape),
            ps(this, ys(Shape).apply(this, arguments))
        }
        return ws(Shape, Element),
        Shape
    }();
    zi(Shape, "Shape");
    var Circle = function(t) {
        function Circle(t) {
            return Ti(this, Circle),
            ps(this, ys(Circle).call(this, Ri("circle", t), t))
        }
        return ws(Circle, Shape),
        as(Circle, [{
            key: "radius",
            value: function(t) {
    ...
    var Container = function(t) {
        function Container() {
            return Ti(this, Container),
            ps(this, ys(Container).apply(this, arguments))
        }
        return ws(Container, Element),
        as(Container, [{
            key: "flatten",
            value: function(t) {
                return this.each(function() {
    ...
    var Defs = function(t) {
        function Defs(t) {
            return Ti(this, Defs),
            ps(this, ys(Defs).call(this, Ri("defs", t), t))
        }
        return ws(Defs, Container),
        as(Defs, [{
            key: "flatten",
            value: function() {
                return this
    ...
    var Ellipse = function(t) {
        function Ellipse(t) {
            return Ti(this, Ellipse),
            ps(this, ys(Ellipse).call(this, Ri("ellipse", t), t))
        }
        return ws(Ellipse, Shape),
        as(Ellipse, [{
            key: "size",
            value: function(t, e) {
                var n = _i(this, t, e);
    ...
    var Stop = function(t) {
        function Stop(t) {
            return Ti(this, Stop),
            ps(this, ys(Stop).call(this, Ri("stop", t), t))
        }
        return ws(Stop, Element),
        as(Stop, [{
            key: "update",
            value: function(t) {
    ...
    var wu = {
      ...
      , Gradient = function(t) {
        function Gradient(t, e) {
            return Ti(this, Gradient),
            ps(this, ys(Gradient).call(this, Ri(t + "Gradient", "string" == typeof t ? null : t), e))
        }
        return ws(Gradient, Container),
        as(Gradient, [{
            key: "stop",
            value: function(t, e, n) {
    ...
    var Pattern = function(t) {
        function Pattern(t) {
            return Ti(this, Pattern),
            ps(this, ys(Pattern).call(this, Ri("pattern", t), t))
        }
        return ws(Pattern, Container),
        as(Pattern, [{
            key: "url",
            value: function() {
                return "url(#" + this.id() + ")"
    ...
    var bu, Image = function(t) {
        function Image(t) {
            return Ti(this, Image),
            ps(this, ys(Image).call(this, Ri("image", t), t))
        }
        return ws(Image, Shape),
        as(Image, [{
            key: "load",
            value: function(t, n) {
                if (!t)
                ...
                return Ro(r, "load", function(t) {
                    ...
                    e instanceof Pattern && 0 === e.width() && 0 === e.height() && e.size(this.width(), this.height()),
    ...
    bu = function(t, e, n) {
        return "fill" !== t && "stroke" !== t || mo.test(e) && (e = n.root().defs().image(e)),
        e instanceof Image && (e = n.root().defs().pattern(0, 0, function(t) {
            t.add(e)
        })),
        e
    }
    ...
    Vi(_u, {
        ...
        parse: function() {
            var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [[0, 0]]
              , e = [];
            if (t instanceof Array) {
                if (t[0]instanceof Array)
                    return t
            } else
                t = t.trim().split(go).map(parseFloat);
            t.length % 2 != 0 && t.pop();
    ...
    var xu = {
      ...
      , Line = function(t) {
        function Line(t) {
            return Ti(this, Line),
            ps(this, ys(Line).call(this, Ri("line", t), t))
        }
        return ws(Line, Shape),
        as(Line, [{
            key: "array",
            value: function() {
    ...
    var Marker = function(t) {
        function Marker(t) {
            return Ti(this, Marker),
            ps(this, ys(Marker).call(this, Ri("marker", t), t))
        }
        return ws(Marker, Container),
        as(Marker, [{
            key: "width",
            value: function(t) {
    ...
    var Eu = {
        ...
        steps: function(i) {
            ...
            o = o.split("-").reverse()[0];
            var s = i;
            return "none" === o ? --s : "both" === o && ++s,
            function(t) {
                var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1]
                  , n = Math.floor(t * i)
                  , r = t * n % 1 == 0;
                return "start" !== o && "both" !== o || ++n,
                e && r && --n,
                0 <= t && n < 0 && (n = 0),
                t <= 1 && s < n && (n = s),
                n / s
      ...
      , Pu = function(t) {
        function n(t) {
            var e;
            return Ti(this, n),
            (e = ps(this, ys(n).call(this))).stepper = t,
            e
        }
        return ws(n, Tu),
        as(n, [{
        ...
        as(r, [{
            ...
            value: function(t, e, n, r) {
                ...
                var i = r.velocity || 0
                  ...
                  , s = t + i * n + o * n * n / 2;
                return r.velocity = i + o * n,
                r.done = Math.abs(e - s) + Math.abs(i) < .002,
                r.done ? e : s
            }
        }]),
        r
    ...
    Vi(Nu, {
        duration: Mu("_duration", Iu),
        overshoot: Mu("_overshoot", Iu)
    });
    var Du = function(t) {
        function o(t, e, n, r) {
            var i;
        ...
        as(o, [{
            ...
            value: function(t, e, n, r) {
                ...
                var i = e - t
                  ...
                  , s = (i - (r.error || 0)) / n
                  , u = this.windup;
                return !1 !== u && (o = Math.max(-u, Math.min(o, u))),
                r.error = i,
                r.integral = o,
                r.done = Math.abs(i) < .001,
    ...
    }, zu = "mlhvqtcsaz".split(""), qu = 0, Yu = zu.length; qu < Yu; ++qu)
        Fu[zu[qu]] = function(o) {
            return function(t, e, n) {
                if ("H" === o)
                    t[0] = t[0] + e.x;
    ...
    Vi(Ru, {
        ...
        move: function(t, e) {
            ...
            !isNaN(t) && !isNaN(e))
                for (var r, i = this.length - 1; 0 <= i; i--)
                    "M" === (r = this[i][0]) || "L" === r || "T" === r ? (this[i][1] += t,
                    this[i][2] += e) : "H" === r ? this[i][1] += t : "V" === r ? this[i][1] += e : "C" === r || "S" === r || "Q" === r ? (this[i][1] += t,
                    this[i][2] += e,
                    this[i][3] += t,
                    this[i][4] += e,
                    "C" === r && (this[i][5] += t,
                    this[i][6] += e)) : "A" === r && (this[i][6] += t,
                    this[i][7] += e);
            return this
        },
        size: function(t, e) {
            var n, r, i = this.bbox();
            for (i.width = 0 === i.width ? 1 : i.width,
            i.height = 0 === i.height ? 1 : i.height,
            n = this.length - 1; 0 <= n; n--)
                "M" === (r = this[n][0]) || "L" === r || "T" === r ? (this[n][1] = (this[n][1] - i.x) * t / i.width + i.x,
                this[n][2] = (this[n][2] - i.y) * e / i.height + i.y) : "H" === r ? this[n][1] = (this[n][1] - i.x) * t / i.width + i.x : "V" === r ? this[n][1] = (this[n][1] - i.y) * e / i.height + i.y : "C" === r || "S" === r || "Q" === r ? (this[n][1] = (this[n][1] - i.x) * t / i.width + i.x,
                this[n][2] = (this[n][2] - i.y) * e / i.height + i.y,
                this[n][3] = (this[n][3] - i.x) * t / i.width + i.x,
                this[n][4] = (this[n][4] - i.y) * e / i.height + i.y,
                "C" === r && (this[n][5] = (this[n][5] - i.x) * t / i.width + i.x,
                this[n][6] = (this[n][6] - i.y) * e / i.height + i.y)) : "A" === r && (this[n][1] = this[n][1] * t / i.width,
        ...
        parse: function() {
            ...
            for (var r = [], i = new Rs, o = new Rs, s = 0, u = e.length; _o.test(e[s]) ? (t = e[s],
            ++s) : "M" === t ? t = "L" : "m" === t && (t = "l"),
            r.push(Fu[t].call(null, e.slice(s, s += n[t.toUpperCase()]).map(parseFloat), i, o)),
            s < u; )
                ;
            return r
        },
        bbox: function() {
            return zs().path.setAttribute("d", this.toString()),
            zs.nodes.path.getBBox()
        }
    });
    var Xu = function() {
        function e(t) {
        ...
        return as(e, [{
            key: "from",
            value: function(t) {
                return null == t ? this._from : (this._from = this._set(t),
                this)
            }
        }, {
            key: "to",
            value: function(t) {
                return null == t ? this._to : (this._to = this._set(t),
                this)
            }
        }, {
            key: "type",
            value: function(t) {
                return null == t ? this._type : (this._type = t,
                this)
            }
        }, {
            key: "_set",
            value: function(t) {
                ...
                return this._type === fs && (n = this._to ? n[this._to[4]]() : this._from ? n[this._from[4]]() : n),
                n = n.toArray(),
                this._morphObj = this._morphObj || new this._type,
                this._context = this._context || Array.apply(null, Array(n.length)).map(Object).map(function(t) {
                    return t.done = !0,
                    t
                }),
                n
            ...
            key: "stepper",
            value: function(t) {
                return null == t ? this._stepper : (this._stepper = t,
                this)
            }
        }, {
            key: "done",
    ...
    var Path = function(t) {
        function Path(t) {
            return Ti(this, Path),
            ps(this, ys(Path).call(this, Ri("path", t), t))
        }
        return ws(Path, Shape),
        as(Path, [{
            key: "array",
            value: function() {
    ...
    var Qu = {
      ...
      , Polygon = function(t) {
        function Polygon(t) {
            return Ti(this, Polygon),
            ps(this, ys(Polygon).call(this, Ri("polygon", t), t))
        }
        return ws(Polygon, Shape),
        Polygon
    }();
    Nr({
        Container: {
    ...
    var Polyline = function(t) {
        function Polyline(t) {
            return Ti(this, Polyline),
            ps(this, ys(Polyline).call(this, Ri("polyline", t), t))
        }
        return ws(Polyline, Shape),
        Polyline
    }();
    Nr({
        Container: {
    ...
    var Rect = function(t) {
        function Rect(t) {
            return Ti(this, Rect),
            ps(this, ys(Rect).call(this, Ri("rect", t), t))
        }
        return ws(Rect, Shape),
        Rect
    }();
    Vi(Rect, {
        rx: au,
    ...
    Ct({
        ...
        splice: function(t, e) {
            ...
            if (n < (A.length = r)) {
                for (i = h; i < a - r; i++)
                    s = i + n,
                    (o = i + r)in u ? u[s] = u[o] : delete u[s];
                for (i = a; a - r + n < i; i--)
                    delete u[i - 1]
            } else if (r < n)
                for (i = a - r; h < i; i--)
                    s = i + n - 1,
                    (o = i + r - 1)in u ? u[s] = u[o] : delete u[s];
            for (i = 0; i < n; i++)
                u[i + h] = arguments[i + 2];
            return u.length = a - r + n,
            A
        }
    });
    var Zu = function() {
        ...
        return as(t, [{
            ...
            value: function(t) {
                ...
                return this._last ? (e.prev = this._last,
                this._last.next = e,
      ...
      , Ku = {
        ...
        transforms: [],
        frame: function(t) {
            var e = Ku.frames.push({
                run: t
            });
            return null === Ku.nextDraw && (Ku.nextDraw = Ei.window.requestAnimationFrame(Ku._draw)),
            e
        },
        ...
        _draw: function(t) {
            for (var e = null, n = Ku.timeouts.last(); (e = Ku.timeouts.shift()) && (t >= e.time ? e.run() : Ku.timeouts.push(e),
            e !== n); )
                ;
            for (var r = null, i = Ku.frames.last(); r !== i && (r = Ku.frames.shift()); )
                r.run(t);
            for (var o = null; o = Ku.immediates.shift(); )
                o();
      ...
      , na = function(t) {
        ...
        as(n, [{
            ...
            value: function(t, e, n) {
                if (null == t)
                    return this._runners.map(ta);
                var r = 0
                  , i = this.getEndTime();
                if (e = e || 0,
                null == n || "last" === n || "after" === n)
                    r = i;
                else if ("absolute" === n || "start" === n)
                    r = e,
                    e = 0;
                else if ("now" === n)
                    r = this._time;
                ...
                return this._lastRunnerId = t.id,
            ...
            value: function(t) {
                ...
                return e < 0 || (this._runners.splice(e, 1),
            ...
            key: "updateTime",
            value: function() {
                return this.active() || (this._lastSourceTime = this._timeSource()),
                this
            }
        }, {
            key: "play",
            ...
            key: "finish",
            value: function() {
                return this.time(this.getEndTimeOfTimeline() + 1),
                this.pause()
            }
        }, {
            key: "speed",
            value: function(t) {
                return null == t ? this._speed : (this._speed = t,
                this)
            }
        }, {
            key: "reverse",
            ...
            key: "time",
            value: function(t) {
                return null == t ? this._time : (this._time = t,
                this._continue(!0))
            }
        }, {
            key: "persist",
            value: function(t) {
                return null == t ? this._persist : (this._persist = t,
                this)
            }
        }, {
            key: "source",
            value: function(t) {
                return null == t ? this._timeSource : (this._timeSource = t,
                this)
            }
        }, {
            key: "_stepFn",
            value: function() {
                ...
                for (var u = !1, a = 0, h = this._runners.length; a < h; a++) {
                    ...
                    c.active())
                        if (c.step(f).done) {
                            if (!0 !== l.persist) {
                                c.duration() - c.time() + this._time + l.persist < this._time && (c.unschedule(),
                                --a,
                                --h)
                            }
                        } else
                ...
                return u && !(this._speed < 0 && 0 === this._time) || this._runnerIds.length && this._speed < 0 && 0 < this._time ? this._continue() : (this.pause(),
                this.fire("finished")),
                this
            }
        }, {
            ...
            value: function() {
                var t = 0 < arguments.length && void 0 !== arguments[0] && arguments[0];
                return Ku.cancelFrame(this._nextFrame),
                this._nextFrame = null,
                t ? this._stepImmediate() : (this._paused || (this._nextFrame = Ku.frame(this._step)),
                this)
            }
        }, {
            key: "active",
    ...
    Nr({
        Element: {
            timeline: function(t) {
                return null == t ? (this._timeline = this._timeline || new na,
                this._timeline) : (this._timeline = t,
                this)
            }
        }
    });
    var oa = function(t) {
        function o(t) {
            ...
            t = "function" == typeof (t = null == t ? Qs.duration : t) ? new Pu(t) : t,
            e._element = null,
            e._timeline = null,
            e.done = !1,
            e._queue = [],
        ...
        as(o, [{
            key: "element",
            value: function(t) {
                return null == t ? this._element : ((this._element = t)._prepareRunner(),
                this)
            }
        }, {
            key: "timeline",
            value: function(t) {
                return void 0 === t ? this._timeline : (this._timeline = t,
                this)
            }
        }, {
            key: "animate",
            value: function(t, e, n) {
                var r = o.sanitise(t, e, n)
                  , i = new o(r.duration);
                return this._timeline && i.timeline(this._timeline),
            ...
            key: "schedule",
            value: function(t, e, n) {
                if (t instanceof na || (n = e,
                e = t,
                t = this.timeline()),
                !t)
                    throw Error("Runner cannot be scheduled without timeline");
                return t.schedule(this, e, n),
                this
            }
        }, {
            key: "unschedule",
            value: function() {
                var t = this.timeline();
                return t && t.unschedule(this),
                this
            }
        }, {
            key: "loop",
            value: function(t, e, n) {
                return "object" === ce(t) && (e = t.swing,
                n = t.wait,
                t = t.times),
                this._times = t || 1 / 0,
                this._swing = e || !1,
            ...
            key: "position",
            value: function(t) {
                var e, n = this._time, i = this._duration, o = this._wait, r = this._times, s = this._swing, u = this._reverse;
                if (null == t) {
                    var a = function(t) {
                      ...
                      , h = r * (o + i) - o;
                    return e = n <= 0 ? Math.round(a(1e-5)) : n < h ? a(n) : Math.round(a(h - 1e-5)),
                    e
                }
                var l = Math.floor(this.loops())
                  , c = s && l % 2 == 0;
                return e = l + (c && !u || u && c ? t : 1 - t),
                this.loops(e)
            }
        }, {
            key: "progress",
            ...
            value: function(t) {
                ...
                i && this.fire("start", this);
                var s = this._isDeclarative;
                if (this.done = !s && !o && this._time >= r,
                this._reseted = !1,
                n || s) {
                    this._initialise(n),
                    this.transforms = new Fs;
                    var u = this._run(s ? t : e);
                    this.fire("step", this)
                }
                return this.done = this.done || u && s,
            ...
            key: "reset",
            value: function() {
                return this._reseted || (this.time(0),
                this._reseted = !0),
                this
            }
        }, {
            ...
            key: "reverse",
            value: function(t) {
                return this._reverse = null == t ? !this._reverse : t,
                this
            }
        }, {
            key: "ease",
            value: function(t) {
                return this._stepper = new Cu(t),
                this
            }
        }, {
            key: "active",
            value: function(t) {
                return null == t ? this.enabled : (this.enabled = t,
                this)
            }
        }, {
            ...
            value: function(t, e, n) {
                if (this._history[t]) {
                    if (!this._history[t].caller.initialised) {
                        ...
                        return this._queue.splice(r, 1),
                        !1
                    }
                    this._history[t].caller.retarget ? this._history[t].caller.retarget(e, n) : this._history[t].morpher.to(e),
            ...
            key: "addTransform",
            value: function(t, e) {
                return this.transforms.lmultiplyO(t),
                this
            }
        }, {
            key: "clearTransform",
            value: function() {
                return this.transforms = new Fs,
                this
            }
        }, {
            ...
            value: function(t, e, n) {
                ...
                return e = e || Qs.delay,
                n = n || "last",
                "object" !== ce(t = t || Qs.duration) || t instanceof Tu || (e = t.delay || e,
                n = t.when || n,
                i = t.swing || i,
                r = t.times || r,
                o = t.wait || o,
    ...
    var ha = function() {
        ...
        return as(t, [{
            ...
            value: function(t) {
                ...
                return this.ids.splice(e, 1),
                this.runners.splice(e, 1),
                this
            }
        }, {
            key: "merge",
            value: function() {
                ...
                return this.runners.forEach(function(t, e) {
                    r && t.done && r.done && (!t._timeline || !t._timeline._runnerIds.includes(t.id)) && (!r._timeline || !r._timeline._runnerIds.includes(r.id)) && (n.remove(t.id),
                    n.edit(r.id, t.mergeWith(r))),
                    r = t
                }),
                this
            }
            ...
            value: function(t, e) {
                ...
                return this.ids.splice(n, 1, t + 1),
                this.runners.splice(n, 1, e),
                this
            }
        }, {
            key: "length",
    ...
    Nr({
        Element: {
            ...
            _addRunner: function(t) {
                ...
                this._frameId = Ku.immediate(function() {
    ...
    Vi(oa, {
        ...
        styleAttr: function(e, n, t) {
            ...
            return this.queue(function() {
                ...
                return this.element()[e](n, i.at(t)),
                i.done()
            }),
            this
        },
        zoom: function(t, n) {
            if (this._tryRetarget("zoom", gu, n))
                return this;
            var r = new Xu(this._stepper).to(new Ks(t));
            return this.queue(function() {
                r = r.from(this.element().zoom())
            }, function(t) {
                return this.element().zoom(r.at(t), n),
                r.done()
            }, function(t, e) {
                n = e,
                r.to(t)
        ...
        transform: function(v, d, p) {
            ...
            return this.queue(function() {
                ...
                (t.origin || "center").toString() !== (v.origin || "center").toString() && (m = xi(v, g)),
                v = ia({}, t, {
                    origin: m
                })
            }, !0),
        ...
        size: function(t, e) {
            var n;
            return t && e || (n = this._element.bbox()),
    ...
    var la = function(t) {
        function e(t) {
            return Ti(this, e),
            ps(this, ys(e).call(this, Ri("symbol", t), t))
        }
        return ws(e, Container),
        e
    }();
    Nr({
        Container: {
    ...
    var ca = {
      ...
      , Text = function(t) {
        function Text(t) {
            var e;
            return Ti(this, Text),
            (e = ps(this, ys(Text).call(this, Ri("text", t), t))).dom.leading = new Ks(1.3),
            e._rebuild = !0,
            e._build = !1,
            e
        }
        return ws(Text, Shape),
        as(Text, [{
            key: "x",
            value: function(t) {
            ...
            value: function(t) {
                if (void 0 === t) {
                    ...
                    for (var r = 0, i = e.length; r < i; ++r)
                        "textPath" !== e[r].nodeName ? (r !== n && 3 !== e[r].nodeType && !0 === Li(e[r]).dom.newLined && (t += "\n"),
            ...
            key: "leading",
            value: function(t) {
                return null == t ? this.dom.leading : (this.dom.leading = new Ks(t),
                this.rebuild())
            }
        }, {
            key: "rebuild",
            value: function(t) {
                ...
                this._rebuild) {
                    var n = this
                      ...
                      , i = this.dom.leading;
                    this.each(function() {
                        var t = Ei.window.getComputedStyle(this.node).getPropertyValue("font-size")
                          , e = i * new Ks(t);
                        this.dom.newLined && (this.attr("x", n.attr("x")),
                        "\n" === this.text() ? r += e : (this.attr("dy", e + r),
                        r = 0))
                    }),
                    this.fire("rebuild")
                }
    ...
    var Tspan = function(t) {
        function Tspan(t) {
            return Ti(this, Tspan),
            ps(this, ys(Tspan).call(this, Ri("tspan", t), t))
        }
        return ws(Tspan, Text),
        as(Tspan, [{
            key: "text",
            value: function(t) {
    ...
    var ClipPath = function(t) {
        function ClipPath(t) {
            return Ti(this, ClipPath),
            ps(this, ys(ClipPath).call(this, Ri("clipPath", t), t))
        }
        return ws(ClipPath, Container),
        as(ClipPath, [{
            key: "remove",
            value: function() {
    ...
    var fa = function(t) {
        function e(t) {
            return Ti(this, e),
            ps(this, ys(e).call(this, Ri("foreignObject", t), t))
        }
        return ws(e, Element),
        e
    }();
    ...
    var G = function(t) {
        function G(t) {
            return Ti(this, G),
            ps(this, ys(G).call(this, Ri("g", t), t))
        }
        return ws(G, Container),
        as(G, [{
            key: "x",
            value: function(t) {
                var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : this.bbox();
            ...
            value: function() {
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0
                  , e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0
                  , n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : this.bbox()
                  , r = t - n.x
                  , i = e - n.y;
    ...
    var A = function(t) {
        function A(t) {
            return Ti(this, A),
            ps(this, ys(A).call(this, Ri("a", t), t))
        }
        return ws(A, Container),
        as(A, [{
            key: "to",
            value: function(t) {
    ...
    var Mask = function(t) {
        function Mask(t) {
            return Ti(this, Mask),
            ps(this, ys(Mask).call(this, Ri("mask", t), t))
        }
        return ws(Mask, Container),
        as(Mask, [{
            key: "remove",
            value: function() {
                return this.targets().forEach(function(t) {
    ...
    var Style = function(t) {
        function Style(t) {
            return Ti(this, Style),
            ps(this, ys(Style).call(this, Ri("style", t), t))
        }
        return ws(Style, Element),
        as(Style, [{
            key: "addText",
            value: function() {
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "";
    ...
    var TextPath = function(t) {
        function TextPath(t) {
            return Ti(this, TextPath),
            ps(this, ys(TextPath).call(this, Ri("textPath", t), t))
        }
        return ws(TextPath, Text),
        as(TextPath, [{
            key: "array",
            value: function() {
                var t = this.track();
    ...
    Nr({
        Container: {
            textPath: Hi(function(t, e) {
                return t instanceof Text || (t = this.text(t)),
                t.path(e)
            })
        },
        Text: {
            path: Hi(function(t) {
                ...
                if (t instanceof Path || (t = this.defs().path(t)),
                r.attr("href", "#" + t, Ai),
                n)
                    for (; e = this.node.firstChild; )
        ...
        Path: {
            text: Hi(function(t) {
                return t instanceof Text || (t = (new Text).addTo(this.parent()).text(t)),
                t.path(this)
            }),
            targets: function() {
    ...
    var Use = function(t) {
        function Use(t) {
            return Ti(this, Use),
            ps(this, ys(Use).call(this, Ri("use", t), t))
        }
        return ws(Use, Shape),
        as(Use, [{
            key: "element",
